...
/**
 * Created by Amethyst on 16/1/13/10/03.
 */
public class PullGirdView extends GridView implements OnScrollListener{
        ...
        public PullGirdView(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.context= context;
            init(context);
        }
        ...
        private void changeHeaderViewByState() {
            switch (state) {
                ...
                case DONE:
                    ...
                    progressBar.setVisibility(View.GONE);
                    arrowImageView.clearAnimation();
                    arrowImageView.setImageResource(R.mipmap.arrow_down);
                    tipsTextview.setText("下拉刷新");
                    lastUpdatedTextView.setVisibility(View.VISIBLE);
                    Log.v(TAG, "当前状态，done");
                    break;
